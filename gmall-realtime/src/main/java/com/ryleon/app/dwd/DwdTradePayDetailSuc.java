...
public class DwdTradePayDetailSuc {
    ...
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.executeSql("" +
                ...
                ")" + MyKafkaUtil.getFlinkKafkaDdl("dwd_trade_order_detail","pay_detail_suc_order_211126"));
        ...
        tableEnv.executeSql("" +
                ...
                ")" + MyKafkaUtil.getFlinkKafkaUpsertSinkDdl("dwd_trade_pay_detail_suc"));
